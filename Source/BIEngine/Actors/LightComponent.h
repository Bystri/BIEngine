...
namespace BIEngine
{
    ...
    {
    public:
        DirectionalLightComponent() : BaseRenderComponent(), m_pDirectionalLightNode(nullptr) {}
    ...
    {
    public:
        PointLightComponent() : BaseRenderComponent(), m_pPointLightNode(nullptr) {}
    ...
    {
    public:
        SpotLightComponent() : BaseRenderComponent(), m_pSpotLightNode(nullptr) {}
