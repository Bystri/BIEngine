...
namespace BIEngine
{
    ...
    {
    public:
        SpriteRenderComponent() : MeshBaseRenderComponent(), m_pSpriteNode(nullptr) {}
    ...
    {
    public:
        BoxRenderComponent() : MeshBaseRenderComponent(), m_pModelNode(nullptr), m_width(1.0f), m_height(1.0f), m_depth(1.0f) {}
